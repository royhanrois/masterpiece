    ...
    <div class="d-flex" id="wrapper" data-aos="fade-right">
      ...
      <div class="border-right" id="sidebar-wrapper">
        ...
        <div class="list-group list-group-flush">
          ...
          <a href="?page=transactions" class="list-group-item list-group-item-action<?= $page == 'transactions' ? ' active' : ''; ?> <?= $page == 'transactions-details' ? ' active' : ''; ?> <?= $page == 'transfer' ? ' active' : ''; ?>">
            Transactions
          </a>
          <a href="?page=profile" class="list-group-item list-group-item-action<?= $page == 'profile' ? ' active' : ''; ?> <?= $page == 'profile-details' ? ' active' : ''; ?>">
            profile
          </a>
          <a href="../index.php" class="list-group-item list-group-item-action<?= $page == 'logout' ? ' active' : ''; ?>">
            Back To Home
          </a>
